...
global.owner = process.env.OWNER_NUMBER  || '923121964495' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zNkllLpK#lExIoAbqLIJNfkks6a1U6DvkNMKLxRGej0LRtOe5sDU' ,
